...
function GallerySlider({ 
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Controls Superiores - Solo reproducción y navegación */}
      ...
      {/* Imagen Principal Grande CON BOTONES ANTES/DESPUÉS SUPERPUESTOS */}
      <div className="relative bg-gray-900 rounded-2xl overflow-hidden aspect-[4/3] md:aspect-[16/9]">
        ...
        {/* ← ← ← BOTONES ANTES/DESPUÉS SUPERPUESTOS SOBRE LA IMAGEN ← ← ← */}
        {afterUrl && (
          <div className="absolute top-4 left-1/2 -translate-x-1/2 flex items-center gap-2 bg-white/95 backdrop-blur-sm rounded-lg p-1 shadow-lg z-10">
            <button
